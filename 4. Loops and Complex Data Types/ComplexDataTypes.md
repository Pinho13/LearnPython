...
- [Lists](nested_pages/Lists.md) - [1, 2, 3]
- [Tuples](nested_pages/Tuples.md) - (1, 2, 3)
- [Sets](nested_pages/Sets.md) - {1, 2, 3}
- [Dictionaries](nested_pages/Dictionaries.md) - {"one": 1, "two": 2, "three": 3}
> Click in each one of them to know more
